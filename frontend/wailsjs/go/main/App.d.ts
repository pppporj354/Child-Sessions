...
export function AddReward(
  ...
  arg4: number,
  arg5: string
): Promise<model.Reward>

export function AutoPauseInactiveActivities(
  arg1: number,
  arg2: number
): Promise<Array<model.SessionActivity>>

export function CreateActivity(
  arg1: string,
  arg2: string,
  arg3: number
): Promise<model.Activity>
...
export function GetActiveActivitiesInSession(
  arg1: number
): Promise<Array<model.SessionActivity>>
...
export function GetChildProgressSummary(
  arg1: number
): Promise<Record<string, any>>
...
export function LogFlashcardResponse(
  arg1: number,
  arg2: number,
  arg3: string,
  arg4: string
): Promise<model.SessionFlashcard>

export function StartActivityInSession(
  arg1: number,
  arg2: number,
  arg3: string
): Promise<model.SessionActivity>
...
export function UpdateActivityInSession(
  arg1: number,
  arg2: string
): Promise<model.SessionActivity>
...
export function UpdateSessionSummaryNotes(
  arg1: number,
  arg2: string
): Promise<void>
